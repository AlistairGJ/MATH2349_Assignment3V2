...
The characters `,[:space:]`, `::`, `[:digit:]` & `||` were stripped from the `participant_status` in the same manner as for `participant_gender`. The same methodology was then used to generate counts (`)
...
Using the URL stem "http://www.gunviolencearchive.org/incident/"
...
gvd2015_keep_cali$UnharmedArrested_count <- str_count(gvd2015_keep_cali$participant_status, pattern = "UnharmedArrested") # Stringr
