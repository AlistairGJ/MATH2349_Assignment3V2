...
Based on the output of the above `gvd` summary table (`data.frame(...`), the `participant_age` and `participant_gender` were explored to better understand their values. 



It was noted that each cell contains multiple instances of data


each of these columns contains multiple values. 
