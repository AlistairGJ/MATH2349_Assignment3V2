...
gvd2015_keep_cali %>% select(gvd2015_keep_cali, address, incident_url, source_url, incident_url_fields_missing)
...
```{r}
aggregate(state ~ state, gvd2015_keep_cali, function(x) length(unique(x)))
```
